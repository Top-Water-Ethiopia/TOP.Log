      ...
      <div className="flex items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            {departmentName ? `${departmentName} Members` : "Department Members"}
          </h1>
          <p className="text-muted-foreground mt-2">Assign users to this department with a department-scoped role.</p>
        </div>
