    ...
    <div className="bg-background relative flex min-h-screen items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="space-y-1">
          <CardTitle className="text-primary text-center text-3xl font-bold">TOP Log</CardTitle>
          <CardDescription className="text-center">Secure Access Portal</CardDescription>
        </CardHeader>
