...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group border-input dark:bg-input/30 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] duration-150 ease-in-out outline-none',
  ...
  'text-sm shadow-none flex gap-2 items-center',
  {
    variants: {
      size: {
        ...
        sm: 'h-8 px-2 gap-2 rounded-md has-[>svg]:px-2',
        'icon-xs':
