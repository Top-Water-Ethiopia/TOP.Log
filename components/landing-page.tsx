      ...
      <div className="mx-auto flex h-full w-full max-w-3xl flex-col justify-center space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-muted-foreground text-sm">
            {hasReportsForAllAllowedDates
              ? "You've already submitted reports for the last 3 allowed days. You can still review your existing reports."
              : canCreateNewReport
        ...
        {hasReportsForAllAllowedDates && hasSubmittedReports && (
          <div
            onClick={onViewReports}
            onKeyDown={(e) => {
              if (e.key === "Enter" || e.key === " ") {
