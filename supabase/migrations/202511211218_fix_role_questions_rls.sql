-- Migration to fix RLS policies for role_questions
-- Allows super admin access

-- Drop existing policies
DROP POLICY IF EXISTS "Users can view questions for their role" ON public.role_questions;
DROP POLICY IF EXISTS "Admins can view all role questions" ON public.role_questions;
DROP POLICY IF EXISTS "Admins can create role questions" ON public.role_questions;
DROP POLICY IF EXISTS "Admins can update role questions" ON public.role_questions;
DROP POLICY IF EXISTS "Admins can delete role questions" ON public.role_questions;
