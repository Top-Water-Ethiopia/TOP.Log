-- Fix ambiguous user_id column references
-- This migration fixes the "column reference user_id is ambiguous" error

-- Fix is_admin() function to use explicit table alias
...
-- Fix get_users_with_emails() function to use explicit table aliases
